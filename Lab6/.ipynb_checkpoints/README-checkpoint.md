...
---
| Номер варианта | Данные | Зависимая перемменная | Объясняющие переменные |
|:--------------:|:------|:---------------------:|:----------------------|
| 15             | defoult_of_credit <br> card_clients | -Y | все, кроме: Y, PAY_4, PAY_5, PAY_6, BILL_AMT4, BILL_AMT5, BILL_AMT6, PAY_AMT4, PAY_AMT5, PAY_AMT6 |